class StoryParamsBuilder {
   storiesParams = [];
   add = (...params) => {
      this.storiesParams.push(params);
      return this;
   };
   getStoriesParams = () => this.storiesParams;
}

export function makeStories(TableInspector) {
   return new StoryParamsBuilder()
      .add('simple', () => (
         <TableInspector
            data={[
